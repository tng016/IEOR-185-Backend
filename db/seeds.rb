...
users = [ {name: "Nathan Blake", title: "Master Tutor", description: "Hello! I'm Nathan, a 3rd year studying Math. When I'm not busy with school, I'm probably swimming, or hiking to enjoy some cool view. Stats 70 was one of my favorite classes and I'm gonna make sure it's one of yours too.", prof_pic: "https://upload.wikimedia.org/wikipedia/commons/1/13/Daniel_Ingram_Profile.png", rating:5},
